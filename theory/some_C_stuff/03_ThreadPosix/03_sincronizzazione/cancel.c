...
int main()
{
	...
	int rc, t, *p;
	pthread_attr_t attr; /*okaaay qui la definisce, va beneee*/
	...
	/* 
	un thread DETACHED è un thread che quando termina non vuole restituire un risultato a nessuno
	*/
	...
	/* uccido il pthread creato per secondo */
	pthread_cancel(vthreads[1]);
